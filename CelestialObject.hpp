...
class CelestialObject:public CelestialBody, public std::enable_shared_from_this<CelestialBody>{
	...
	public:
		...
		CelestialObject(double Mass, double xPos, double yPos, double xVel,double yVel,std::string name);
		CelestialObject();
		//getters
		...
		virtual double getDistX(std::shared_ptr<CelestialBody> obj) const override;
		virtual double getDistY(std::shared_ptr<CelestialBody> obj) const override;
		virtual double getDistX(std::shared_ptr<CelestialBody> obj,double) const override;
		virtual double getDistY(std::shared_ptr<CelestialBody> obj,double) const override;
		virtual void PlugToOrbiting(std::shared_ptr<CelestialBody> obj);
		virtual std::string getName() const override;
		virtual std::vector<std::shared_ptr<CelestialBody>> getObjects() const override;
		virtual std::vector<std::shared_ptr<CelestialBody>> getRelevantBodies() const override;
        virtual std::shared_ptr<CelestialBody> getOrbittingBody() const override;
		...
		virtual void addOrbitingBody(std::shared_ptr<CelestialBody>) override ;
		virtual void setOrbiting(std::shared_ptr<CelestialBody>) override ;
		virtual void setRelevantBodies() override;
		virtual void eulerStep(double dt) override;
		virtual void setRelevantBodiesAll(std::shared_ptr<CelestialBody> obj) override ;
